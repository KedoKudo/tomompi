...
set(HDF4_CFLAGS     "-O3 -fPIC")
set(HDF4_CPPFLAGS   "-I${HDF4_DIR}/include -DBIG_LONGS -DSWAP")
ExternalProject_Add(${HDF4_PREFIX}
    PREFIX              ${HDF4_PREFIX}
    URL                 ${HDF4_URL}
    URL_MD5             ${HDF4_URL_MD5}
    CONFIGURE_COMMAND   ${HDF4_SRC}/configure --with-pic --enable-production --with-szlib=${HDF4_DIR} --with-zlib=${HDF4_DIR} --prefix=${HDF4_DIR}
