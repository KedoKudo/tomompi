...
public:
	...
	int GetDatum (char *index, unsigned int *get_data);
	int GetDatum (char *index, int *get_data);
	...
	int GetDatumSlab (char *index, unsigned int *get_data, int *start_dims, int *size_dims);
	int GetDatumSlab (char *index, int *get_data, int *start_dims, int *size_dims);
