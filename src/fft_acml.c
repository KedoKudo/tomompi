...
void  MCFFT1D (float data[], unsigned long n, int zero, float *comm)
{
int		info;
//int	    loop;
...
{
    /* The required storage is (5*N)+100 complex elements = (5*N+100)*2 floats */
    comm = malloc(((5 * n) + 100) * sizeof(float) * 2);
