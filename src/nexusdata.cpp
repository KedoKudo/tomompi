...
void NexusData::PutDataVal (unsigned short *new_data){
    ...
    if (data != NULL)
        memcpy (data, new_data, sizeof (unsigned short int));
...
void NexusData::PutDataVal (short *new_data){
    ...
    if (data != NULL)
        memcpy (data, new_data, sizeof (short int));
...
void NexusData::PutDataVal (unsigned long *new_data){
    ...
    if (data != NULL)
        memcpy (data, new_data, sizeof (unsigned int));
...
void NexusData::PutDataVal (long *new_data){
    ...
    if (data != NULL)
        memcpy (data, new_data, sizeof (int));
